...
const ListView = {
    ...
    renderItems: function(items) {
        ...
        items.forEach(item => {
            ...
            let descHTML;
            if (typeof item.desc === 'object' && item.desc !== null) descHTML = `<div class="itemDesc">${item.desc.text}<div class="listViewProgress"><div class="listViewProgressBar" style="width:${item.desc.value/item.desc.max*100}%;background-color:${item.desc.color??=''}"></div></div></div>`;
